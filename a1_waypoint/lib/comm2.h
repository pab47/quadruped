...
// #pragma pack(1)
	...
	// 	uint32_t reserve;
	// 	uint32_t crc;
	// } LowState;                            //PAB47:  low level feedback
	//
	// typedef struct
	// {
	// 	uint8_t levelFlag;
	...
	// 	uint32_t reserve;
	// 	uint32_t crc;
	// } LowCmd;                              //PAB47:  low level control
	...
	// 	uint32_t reserve;
	// 	uint32_t crc;
	// } HighState;                           //NOT USED: A1 high level feedback
	...
	typedef struct
	{
		...
		Cartesian footPosition2Body[4];    // foot position relative to body
		Cartesian footSpeed2Body[4];       // foot speed relative to body
		Cartesian shoulderPos[4];
		Cartesian elbowPos[4];
		Cartesian footPos[4];
		// Cartesian com;
		// Cartesian bodyWorldPos;
		// Cartesian bodyWorldVel;
		// Cartesian est_bodyWorldPos;
		// Cartesian est_bodyWorldVel;
		// Cartesian est_accelerometer;
		float foot_Force[4];
		int16_t footForce[4];
		int16_t footForceEst[4];
		int step_no;
		...
		float cmd_omega;
		IMU imu;
		// float tracking_error_x;
		// float tracking_error_y;
		// uint32_t tick;                     // reference real-time from motion controller (unit: us)
		// uint8_t wirelessRemote[40];
		// uint32_t reserve;
		// uint32_t crc;
	} RobotState;                           // PAB47: high level feedback
	...
	// 	uint32_t reserve;
	// 	uint32_t crc;
	// } HighCmd;                             // Not used: A1 high level control
